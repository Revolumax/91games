...
export default function Quienes() {
  ...
  const fetchMinecraftUsername = async (uuid: string) => {
    ...
    try {
      ...
      console.log(`El nombre actual es: ${currentName}`);
    } catch (error) {
      console.error('Error al obtener el nombre:', error);
    }
  };
  
  const userUUID = '2e8bcb9e-9b9c-4ddb-86ba-d6f0f5f42ac3'; // Reemplaza con el UUID real
  fetchMinecraftUsername(userUUID);
